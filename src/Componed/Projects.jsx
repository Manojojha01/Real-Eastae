...
const prevProject =()=>{
  ...
  return (
    <div className='container mx-auto pt-20 py-4 md:px-20 lg:px-32 my-20  w-full
    overflow-hidden 'id ='Projects'>
      ...
      <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Carfiting Spaces, Building Legacies-Explore Our Portfolio</p>
    
    
    
     {/*   slider button         */}
     <div className=" flex justify-end items-center mb-8">
      <button onClick={prevProject} className='p-3 bg-gray-300 mr-2 rounded' aria-label='Previous Project'>
        <img src={assets.left_arrow} alt="Previous" className='' />
      </button>
      <button onClick={nextProject} className='p-3 bg-gray-300 mr-2 rounded' aria-label='Next Project'>
        <img src={assets.right_arrow} alt="Next" className='' />
      </button>
     </div>
     {/*  *Projects container*/}
     <div className="overflow-hiddwn">
