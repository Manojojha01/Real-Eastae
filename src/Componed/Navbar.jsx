        ...
        py-4 px-6 md:px-20 lg:px-32 bg-transparent">
            ...
            <ul className='hidden md:flex gap-7 text-white'>
                <a href="#Home" className='cursor-pointer
                 ...
                 <a href="#Testmonials" className='cursor-pointer
                 hover:text-gray-400'>Testmonials</a>
            </ul>
      ...
      <div className={`md:hidden ${showMobileMenu ? 'fixed w-full':'h-0 w-0'}  right-0 top-0 bottom-0
       overflow-hidden bg-white transition-all`}>
        ...
        <ul className='flex flex-col items-center gap-2 mt-5 px-5 text-lg font-medium'>
          ...
          <a onClick={()=>setShowMobileMenu(false)} href="#Testmonials" className='px-4 py-2 rounded-full inline-block'>Testmonials</a>
